...
<html>
    ...
    <body>
        <header>
            <span id="headerTitle">
                <button id="list" onclick="openNav()">
                    <i class="fa fa-th-list" style="font-size:20px">
                    </i>
                </button> 
                Lucrum Martis
            </span>
        ...
        <script>
            ...
            function creditTwo() {
                document.getElementById("main").innerHTML='<object type="text/html" data="credittwo.html" width="100%" height="98.5%"></object>';
            }

            function rent() {
                document.getElementById("main").innerHTML='<object type="text/html" data="rent.html" width="100%" height="98.5%"></object>';
            }

            function power() {
                document.getElementById("main").innerHTML='<object type="text/html" data="power.html" width="100%" height="98.5%"></object>';
            }            

            function internet() {
                document.getElementById("main").innerHTML='<object type="text/html" data="internet.html" width="100%" height="98.5%"></object>';
            }

            function mobile() {
                document.getElementById("main").innerHTML='<object type="text/html" data="mobile.html" width="100%" height="98.5%"></object>';
            }

            function insurance() {
                document.getElementById("main").innerHTML='<object type="text/html" data="insurance.html" width="100%" height="98.5%"></object>';
            }

            function car() {
                document.getElementById("main").innerHTML='<object type="text/html" data="car.html" width="100%" height="98.5%"></object>';
            }

            function flat() {
                document.getElementById("main").innerHTML='<object type="text/html" data="flat.html" width="100%" height="98.5%"></object>';
            }

            function info() {
                document.getElementById("main").innerHTML='<object type="text/html" data="info.html" width="100%" height="98.5%"></object>';
            }

            function calendar() {
                document.getElementById("main").innerHTML='<object type="text/html" data="calendar.html" width="100%" height="98.5%"></object>';
            }

            function notes() {
                document.getElementById("main").innerHTML='<object type="text/html" data="notes.html" width="100%" height="98.5%"></object>';
            }

            function loans() {
                document.getElementById("main").innerHTML='<object type="text/html" data="loans.html" width="100%" height="98.5%"></object>';
            }

            function other() {
                document.getElementById("main").innerHTML='<object type="text/html" data="other.html" width="100%" height="98.5%"></object>';
            }
